...
<div class="year-grid">
  <a href="{{ '/2026/' | relative_url }}" class="year-card">
    <h3>2026</h3>
    <span class="cohort-count">Current cohort</span>
  </a>
  <a href="{{ '/2025/' | relative_url }}" class="year-card">
    <h3>2025</h3>
    <span class="cohort-count">20 students</span>
  </a>
  <a href="{{ '/2024/' | relative_url }}" class="year-card">
    <h3>2024</h3>
    <span class="cohort-count">20 students</span>
  </a>
  <a href="{{ '/2023/' | relative_url }}" class="year-card">
    <h3>2023</h3>
    <span class="cohort-count">18 students</span>
  </a>
</div>
